        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 text-center">
                ...
                <p class="lead text-muted mt-3">
                    ...
                    Platform Informasi Penting dan Pelayanan Masyarakat Kelurahan Tanjung Mas!
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="container mb-5">
        <div class="row d-flex justify-content-between align-items-center">
            <div class="col-lg-6">
                ...
                <p class="text-muted">
                    Tanjung Mas merupakan sebuah nama kelurahan di wilayah Kecamatan Semarang Utara, Kota Semarang, Provinsi
                    Jawa Tengah. Di kelurahan ini terdapat Pelabuhan Tanjung Emas yang merupakan satu-satunya pelabuhan di
                    Semarang. Kelurahan Tanjungmas memiliki jumah penduduk sekitar 29.073 jiwa dengan jumlah RT sebanyak 129
                    buah dan jumlah RW sebanyak 12 buah.
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 mb-4 mb-lg-0">
                    <img src="images/beranda/image2.png" alt="image profile marwah" style="border-radius: 15px"
                        class="img-fluid">
                </div>
                <div class="col-lg-6">
                    <h2 class="fw-bold mb-3 text-danger">Layanan Masyarakat</h2>
                    <p class="text-muted mb-4">Kelurahan Tanjung Mas memberikan layanan kemasyarakatan diantaranya adalah
                        Pembuatan KTP, Pembuatan KK, Pengantar Syarat Nikah, Permohonan Akta Kelahiran, Pengaduan
                        Masyarakat, dll.</p>
                    <div class="row g-3">
            ...
            <div class="row mb-5">
                <div class="col-lg">
                    <div class="py-3 px-4 --box-advantage">
                        ...
                        <p class="text-black-50 headline-paragraph">Organisasi Kemasyarakatan (PKK) Kelurahan Tanjung Mas
                            dalam setiap momentum seperti Posyandu Balita, Kelas Bumil, Lomba, dll.</p>
                    </div>
                </div>
                <div class="col-lg">
                    <div class="py-3 px-4 --box-advantage">
                        ...
                        <p class="text-black-50 headline-paragraph">Organisasi Kepemudaan " Satria Tanjung Anom" (Karang
                            Taruna) Kelurahan Tanjung Mas seperti RAKERDA, Sosialisasi Fotografi dan Videografi, Pentas
                            Seni, dll.</p>
                    </div>
                </div>
            </div>
